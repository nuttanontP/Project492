<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="addLPG.aspx.cs" Inherits="TestAmmy.addLPG" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="content_col9" runat="server">
    ...
    <div>
        <h3>Details of LPG Consumption	</h3>
        <hr />
        <div class="col-sm-4">
            <h4>Building Name:</h4>
