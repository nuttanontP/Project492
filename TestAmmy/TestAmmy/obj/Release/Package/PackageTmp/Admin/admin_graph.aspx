                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <select id="buidling2" name="buidling2" class="form-control select2" multiple="multiple"  data-placeholder="Select assets" onchange="getState(this.value);" style="width: 100%;">
                                                <option value='0'>-SELECT-</option>
                                            </select>
                                        </div>
                                    </div>
