                        ...
                        <div class="col-sm-10 col-sm-offset-0">
                            <div class="nav-tabs-custom ">
                                <ul class="nav nav-tabs " id="myTab">
                                    <li class="active"><a href="#profile" data-toggle="tab"><strong>Electricity</strong></a></li>
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="electric" AutoGenerateColumns="False" class="electric table table-bordered table-striped" HeaderStyle-HorizontalAlign="Center" DataKeyNames="randomID" runat="server" OnRowDeleting="electric_RowDeleting">
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="building_name" HeaderText="Asset Name" NullDisplayText="-" />
                                                                <asp:BoundField DataField="current meter" HeaderText="Meter" NullDisplayText="-" />
                                                                ...
                                                                <asp:BoundField DataField="name" HeaderText="User" NullDisplayText="-" />
                                            ...
                                            <div class="col-sm-12 col-sm-offset-1">
                                                <asp:GridView ID="occupancy" AutoGenerateColumns="False" class="occupancy table table-bordered table-striped" HeaderStyle-HorizontalAlign="Center" DataKeyNames="randomID" runat="server" OnRowDeleting="occupancy_RowDeleting">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="date" HeaderText="Date" DataFormatString="{0:yyyy/MM/dd}" />
                                                        <asp:BoundField DataField="building_name" HeaderText="Asset Name" NullDisplayText="-" />
                                                        <asp:BoundField DataField="Available" HeaderText="Room Available" NullDisplayText="-" />
                                                        <asp:BoundField DataField="Occupied" HeaderText="Room Occupied" NullDisplayText="-" />
