    ...
    public partial class admin_permission : System.Web.UI.Page
    {
        ...
        protected void permissionview_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            if (s != "no")
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "YourUniqueScriptKeyvcd", "alert('" + s_ + "');window.location.href='admin_permission.aspx';", true);
            }
        }
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (s != "no")
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, GetType(), Guid.NewGuid().ToString(), "alert('" + s_ + "');window.location.href='admin_permission.aspx';", true);
                }
                else
                {
