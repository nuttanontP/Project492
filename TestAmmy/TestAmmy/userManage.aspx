...
<%--              Level 2: .col-xs-4 .col-sm-6--%>
              <div class="center-block">
                  <p>NAME : _______________</p><br/>
                  <p>SURNAME : ____________</p><br/>
                  <p>E-MAIL : _____________</p><br/>
                  <p>COMPANY : ____________</p><br/>
                  <p>POSITION : ___________</p><br/>
        ...
        <div class="col-md-7">
            ...
            <div style="text-align:right"><button type="button" class="btn btn-info">edit</button>
            </div>
...
<%--                 Level 2: .col-xs-8 .col-sm-6--%>
            ...
            <div class="col-xs-8">
                ...
                <button type="button" class="btn btn-info btn-lg">Add energy data</button>
                <button type="button" class="btn btn-info btn-lg">Show graph</button>
                <button type="button" class="btn  btn-info btn-lg">Show files</button>
                </div>
            </div>
            <div class="col-xs-2">
<%--                Level 2: .col-xs-4 .col-sm-6--%>
